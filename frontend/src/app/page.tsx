...
import { TweaksContext } from "@/components/app-shell";

const ParticleField = ({ variant = "particles", intensity = 1 }: any) => {
...
export const Reveal = ({ children, delay = 0, as: Tag = "div", ...props }: any) => {
  ...
  return <Tag ref={ref as any} className={`reveal ${visible ? "in" : ""} ${props.className || ""}`} {...props}>{children}</Tag>;
};
