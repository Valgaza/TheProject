/* Nexus — Chat home (domain selector + suggested tasks) */
...
const DomainCard = ({ d, active, onSelect, tilt }) => {
...
const ChatHome = ({ setPage }) => {
  const [domain, setDomain] = React.useState("research");
  const [val, setVal] = React.useState("");
  const inputRef = React.useRef(null);

  const submit = () => { if (val.trim()) { setPage("conversation"); } };
